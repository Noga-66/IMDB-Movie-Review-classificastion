...
3. Upload `app.py`, `model.pkl`, `vectorizer.pkl`, and `requirements.txt`
4. Your app goes live automatically at `https://huggingface.co/spaces/your-username/imdb-sentiment`
...
Built as part of an NLP Classification Assignment using the IMDB 50K Movie Reviews dataset.
